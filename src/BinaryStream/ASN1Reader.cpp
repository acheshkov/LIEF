...
std::string ASN1Reader::tag2str(int tag) {
  ...
  auto handle = [&](int mask, const std::string& name) {
    if ((tag & mask) == mask) {
      tag_str += " | " + name;
    }
  };

  handle(MBEDTLS_ASN1_BOOLEAN, "ASN1_BOOLEAN");
  handle(MBEDTLS_ASN1_INTEGER, "ASN1_INTEGER");
  handle(MBEDTLS_ASN1_BIT_STRING, "ASN1_BIT_STRING");
  handle(MBEDTLS_ASN1_OCTET_STRING, "ASN1_OCTET_STRING");
  handle(MBEDTLS_ASN1_NULL, "ASN1_NULL");
  handle(MBEDTLS_ASN1_OID, "ASN1_OID");
  handle(MBEDTLS_ASN1_ENUMERATED, "ASN1_ENUMERATED");
  handle(MBEDTLS_ASN1_UTF8_STRING, "ASN1_UTF8_STRING");
  handle(MBEDTLS_ASN1_SEQUENCE, "ASN1_SEQUENCE");
  handle(MBEDTLS_ASN1_SET, "ASN1_SET");
  handle(MBEDTLS_ASN1_PRINTABLE_STRING, "ASN1_PRINTABLE_STRING");
  handle(MBEDTLS_ASN1_T61_STRING, "ASN1_T61_STRING");
  handle(MBEDTLS_ASN1_IA5_STRING, "ASN1_IA5_STRING");
  handle(MBEDTLS_ASN1_UTC_TIME, "ASN1_UTC_TIME");
  handle(MBEDTLS_ASN1_GENERALIZED_TIME, "ASN1_GENERALIZED_TIME");
  handle(MBEDTLS_ASN1_UNIVERSAL_STRING, "ASN1_UNIVERSAL_STRING");
  handle(MBEDTLS_ASN1_BMP_STRING, "ASN1_BMP_STRING");
  handle(MBEDTLS_ASN1_PRIMITIVE, "ASN1_PRIMITIVE");
  handle(MBEDTLS_ASN1_CONSTRUCTED, "ASN1_CONSTRUCTED");
  handle(MBEDTLS_ASN1_CONTEXT_SPECIFIC, "ASN1_CONTEXT_SPECIFIC");
